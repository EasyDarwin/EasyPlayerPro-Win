// EasyPlayerProActiveX.cpp : CEasyPlayerProActiveXApp 和 DLL 注册的实现。
...
// CEasyPlayerProActiveXApp::InitInstance - DLL 初始化
...
// CEasyPlayerProActiveXApp::ExitInstance - DLL 终止
